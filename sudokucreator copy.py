...
class _SudokuSolver:
    ...
    def _solve(self) -> Optional['Sudoku']:
        blanks = self.__get_blanks()    #OBTIENE LISTA DE BLANCOS (TUPLAS)
        blank_count = len(blanks)
        are_blanks_filled = [False for _ in range(blank_count)] #HACE LISTA DE CONTROL
